...
SITE_DOMAIN = "recode2s.herokuapp.com"
...
ROOT_URLCONF = "recode2s.urls"

WSGI_APPLICATION = "recode2s.wsgi.application"
...
CACHE_MIDDLEWARE_KEY_PREFIX = "recode2s"
